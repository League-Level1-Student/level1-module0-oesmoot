...
public class BodyPartQuiz {
	...
	private void startQuiz() {
		...
		// -- Tell them they are wrong and who the person is
			...
			JOptionPane.showMessageDialog(null, "INCORRECT! the answer is.............. arnold!");
		}
...
String guess3 = JOptionPane.showInputDialog("who is this?");
		...
		if (guess3.equalsIgnoreCase("leonardo")) {
			...
			JOptionPane.showMessageDialog(null, "INCORRECT! the answer is..............leonardo!");
		}
		showNextImage();
...
String guess4 = JOptionPane.showInputDialog("who is this?");
		...
		if (guess4.equalsIgnoreCase("morgan")) {
			...
			JOptionPane.showMessageDialog(null, "INCORRECT! the answer is..............morgan!");
		}
		showNextImage();
