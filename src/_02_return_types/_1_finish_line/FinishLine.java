...
public class FinishLine {
	...
	public static void main(String[] args) {
		...
		//5. If the robot has crossed the finish line... 
			if(finished) {
				JOptionPane.showMessageDialog(null, "this robot has crossed the finished line and went " + dist + " feet!");
			}
		...
		//7. Else use a pop up to say the robot did not finish and how far it went
				...
				JOptionPane.showMessageDialog(null, "this robot did not cross the finish line, but at least it went " + dist + " feet!");
			}
	}
